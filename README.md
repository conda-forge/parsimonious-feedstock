...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/parsimonious-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/parsimonious-feedstock)
...
Once the `conda-forge` channel has been enabled, `parsimonious` can be installed with:
